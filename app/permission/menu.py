...
from app.model.models import Menu, Role_Menu, User_Role
from app.utils.code_enum import Code
from app.utils.common import construct_menu_data, NO_PARAMETER, SUCCESS, UPDATE_ERROR, ID_NOT_FOUND, PARAMETER_ERR, \
    verify_token, model_to_dict, DELETE_ERROR, CREATE_ERROR
...
@menu.route('/test/')
def test():
    return jsonify({"code":Code.SUCCESS.value})
